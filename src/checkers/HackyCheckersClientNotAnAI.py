...
def update(boardData):
    ...
    ##    changes = find_change(board_data_to_str(BOARD), boardData)
...
def turn():
    ...
    ##    changes = find_change(board_data_to_str(BOARD), newdata)
    ##    if changes:
    ...
    for i in data:
        ...
        if frm == OPPONENT and msg.startswith("w="):
            ...
            if msg != LASTRCVD:
                ...
                # board data.
                changes = find_change(board_data_to_str(BOARD), msg)
                ...
                changes = find_change(board_data_to_str(BOARD), LASTRCVD)
